...
Image_0="/Users/vedindewan/Desktop/MSci_Project_AO/Zygo _nterferometer/5_Element_DM_XYZ_Data/5_Element_DM_Test_21_11_2020_00.xyz"
Image="/Users/vedindewan/Desktop/MSci_Project_AO/Zygo _nterferometer/5_Element_DM_XYZ_Data/5_Element_DM_Test_21_11_2020_15C.xyz"
...
def read_xyz(filename,fig_number,theta,theta_1):
    dr= pd.read_csv(filename, delimiter='\t',skiprows=13,encoding= 'unicode_escape')
    dr.columns=['Coordinates']#naming colums
    pd_df = dr.Coordinates.str.split(' ',expand=True)
    pd_df=pd_df.iloc[:-1,:3]#selecting first 3 colums
...
def main(Image_0,Image):
    theta,theta_1=read_xyz_0(Image_0)
    read_xyz(Image,1,theta,theta_1)
